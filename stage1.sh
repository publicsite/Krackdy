...
wget "https://jenkins.linuxcontainers.org/job/image-debian/architecture=amd64,release=trixie,variant=default/3347/artifact/rootfs.tar.xz"
...
sudo chmod 700 "${thepwd}/mountpoint/workdir/rootfs/etc/skel/.xsession"
...
sudo mkdir -p "${thepwd}/mountpoint/workdir/rootfs/home/kodi/.config"
sudo cp -a "${thepwd}/.xinitrc" "${thepwd}/mountpoint/workdir/rootfs/home/kodi/"
sudo chmod 700 "${thepwd}/mountpoint/workdir/rootfs/home/kodi/.xinitrc"
sudo cp -a "${thepwd}/.profile" "${thepwd}/mountpoint/workdir/rootfs/home/kodi/"
sudo chmod 700 "${thepwd}/mountpoint/workdir/rootfs/home/kodi/.profile"
sudo ln -s .xinitrc "${thepwd}/mountpoint/workdir/rootfs/home/kodi/.xsession"
sudo chmod 700 "${thepwd}/mountpoint/workdir/rootfs/home/kodi/.xsession"
sudo mkdir -p "${thepwd}/mountpoint/workdir/rootfs/home/kodi/.config/gtk-3.0"
...
echo 'sakura &' | sudo tee -a "${thepwd}/mountpoint/workdir/rootfs/root/.xinitrc"
echo 'exec openbox-session' | sudo tee -a "${thepwd}/mountpoint/workdir/rootfs/root/.xinitrc"
...
sudo cp -a "${thepwd}/launchers/run_xemu.sh" "${thepwd}/mountpoint/workdir/rootfs/usr/bin/run_xemu.sh"
...
sudo chmod +x "${thepwd}/mountpoint/workdir/initOverlay.sh"
