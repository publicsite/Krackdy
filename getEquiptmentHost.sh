...
##"${myBuildHome}"/myBuildsHost/firefox-fx-osk/firefox-fx-osk.myBuild get
"${myBuildHome}"/myBuildsHost/kodi-AEL/kodi-AEL.myBuild get
"${myBuildHome}"/myBuildsHost/kodi-AEL/kodi-AEL.myBuild extract
